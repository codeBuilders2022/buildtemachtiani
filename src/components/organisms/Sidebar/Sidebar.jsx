        ...
        <aside className="dark:text-white Sidebar">
            <div className="posted">
                ...
                <div className="dataRead">
                    <div className="title">
                        <div className='left'>
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-book" width="30" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#706a81" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
